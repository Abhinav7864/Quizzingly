...
export const Input = ({ label, id, error, success, helperText, className = '', ...props }: InputProps) => {
  const inputClasses = `w-full bg-gray-800 border-2 rounded-lg shadow-sm py-2.5 px-3.5 text-white placeholder-gray-500 transition-all duration-200 focus:outline-none ${
    error 
