      ...
      <div className="w-full max-w-5xl mx-auto px-4 sm:px-6">
        ...
        <div className="flex items-center justify-between mb-6">
          <div className="flex items-baseline gap-3">
            ...
            <span className="text-[13px] text-[#6B6B6B] font-bold uppercase tracking-wider">
        ...
        {isLoading ? (
          <div className="space-y-4">
            {[1, 2, 3].map((i) => (
              <div key={i} className="h-[64px] bg-white border-2 border-black rounded-xl animate-pulse opacity-40" />
            ))}
          </div>
          ...
          <div className="space-y-3">
            {quizzes.map((quiz, idx) => (
              <motion.div
                ...
                className="group flex items-center justify-between h-[68px] px-6 bg-white border-2 border-black rounded-xl shadow-[4px_4px_0px_black] hover:translate-x-[2px] hover:translate-y-[2px] hover:shadow-[2px_2px_0px_black] transition-all"
              >
                <div className="flex items-center gap-4 min-w-0">
                  <div className="w-8 h-8 rounded-lg bg-[#FFD166] border-2 border-black text-[#1E1E1E] flex items-center justify-center shrink-0">
                  ...
                  <div className="flex items-center gap-1.5 px-2.5 py-0.5 bg-[#F55CA7] border border-black rounded-lg shrink-0">
          ...
          >
            <Link href="/quiz/new">
              <div className="w-16 h-16 bg-[#FFD166] border-2 border-black rounded-xl flex items-center justify-center mb-6 shadow-[4px_4px_0px_black] hover:translate-x-[2px] hover:translate-y-[2px] hover:shadow-[2px_2px_0px_black] transition-all cursor-pointer">
                <Plus size={32} className="text-[#1E1E1E]" />
              </div>
            </Link>
            <h2 className="text-[18px] font-black text-[#1E1E1E] mb-2">Create your first quiz</h2>
