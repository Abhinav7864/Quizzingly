      ...
      >
        <div className="bg-white border-2 border-black rounded-2xl shadow-[6px_6px_0px_black] overflow-hidden">
          ...
          <div className="px-8 py-6 border-b-2 border-black bg-[#FFD166]">
            <h1 className="text-[22px] font-black text-[#1E1E1E] tracking-tight">Sign in</h1>
            <p className="text-[14px] font-bold text-[#1E1E1E]/60 mt-1">Welcome back, explorer</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="p-8 space-y-5">
            ...
            <Button type="submit" id="login-submit" fullWidth size="lg" className="h-12 mt-2" isLoading={loading}>
              Sign in
            </Button>
          </form>
        </div>
        ...
        <p className="text-center text-[13px] text-[#6B6B6B] mt-6 font-bold">
          ...
          <Link href="/register" className="text-[var(--primary)] hover:underline font-black">
            Sign up
          </Link>
        </p>
      </motion.div>
